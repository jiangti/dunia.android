 ...
 * 
 * $Id: config.php 2871 2011-07-12 12:35:01Z olavmrk $
 */
...
$config = array (
	 ...
	 */
	'language.available'	=> array('en', 'no', 'nn', 'se', 'da', 'de', 'sv', 'fi', 'es', 'fr', 'it', 'nl', 'lb', 'cs', 'sl', 'lt', 'hr', 'hu', 'pl', 'pt', 'pt-BR', 'tr', 'ja', 'zh-tw', 'ru', 'et', 'he'),
