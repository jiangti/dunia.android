...
class Aw_Auth_Adapter_Google implements Zend_Auth_Adapter_Interface
{
   ...
   public function authenticate()
   {
      ...
      if(!array_key_exists('error',$this->_accessToken)) {
         ...
         $result['identity'] = new Aw_Auth_Identity_Google($this->_accessToken);
      }
   ...
   public static function getAuthorizationUrl()
   {
      ...
      return Aw_OAuth2_Consumer::getAuthorizationUrl($options['google']);
   }
   ...
   protected function _setRequestToken($requestToken)
   {
      ...
      $accesstoken = Aw_OAuth2_Consumer::getAccessToken($this->_options);
