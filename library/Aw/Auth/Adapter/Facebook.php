...
class Aw_Auth_Adapter_Facebook implements Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        $identity = new Aw_Auth_Identity_Facebook($this->_accessToken);
    ...
    public static function getAuthorizationUrl()
    {
        ...
        return Aw_OAuth2_Consumer::getAuthorizationUrl($options['facebook']);
    }
