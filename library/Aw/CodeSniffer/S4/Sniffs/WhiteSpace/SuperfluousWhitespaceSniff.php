...
class S4_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff
    extends Squiz_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff {

    public $multipleEmptyLinesLimit = 1;
            ...
            */
            ...
            if ($phpcsFile->hasCondition($stackPtr, T_FUNCTION) === true) {
                if ($tokens[($stackPtr - 1)]['line'] < $tokens[$stackPtr]['line'] && $tokens[($stackPtr - 2)]['line'] === $tokens[($stackPtr - 1)]['line']) {
                    ...
                    if ($lines > $this->multipleEmptyLinesLimit) {
