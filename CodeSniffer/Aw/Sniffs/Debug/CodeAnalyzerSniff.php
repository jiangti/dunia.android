<?php
/**
 * Aw_Sniffs_Debug_CodeAnalyzerSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Aw_Sniffs_Debug_CodeAnalyzerSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $analyzerPath = PHP_CodeSniffer::getConfigData('Aw_ca_path');
